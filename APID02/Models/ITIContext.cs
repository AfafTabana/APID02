...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
      //  => optionsBuilder.UseSqlServer("Data Source=DESKTOP-NE1FOI0;Initial Catalog=ITI;Integrated Security=True;Encrypt=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Instructor>()
            ...
            .OnDelete(DeleteBehavior.SetNull); // 👈 This is the key line

        // If needed, also configure Dept_ManagerNavigation (optional)
        modelBuilder.Entity<Department>()
            .HasOne(d => d.Dept_ManagerNavigation)
        ...
        modelBuilder.Entity<Student>()
            .HasOne(s => s.St_superNavigation)  // each student has one supervisor
            .WithMany()                         // no navigation back from supervisor
            .HasForeignKey(s => s.St_super)   // FK in the same table
            .OnDelete(DeleteBehavior.SetNull);
    }
